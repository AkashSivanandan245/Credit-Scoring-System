...
export const DEFAULTS: Record<string, number> = {
  ...
  num_open_loans: 2,
  mobile_banking_logins: 30,
  debit_card_usage_frequency: 15,
  online_transfer_frequency: 10,
  utility_bill_payment_delay: 0,
  digital_payment_frequency: 25,
  shg_repayment_score: 78,
  recharge_frequency: 4,
  avg_recharge_amount: 300,
  debit_card_spending: 8000,
}
